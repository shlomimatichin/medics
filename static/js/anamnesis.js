...
var cases = [
	...
	},
	{
		...
		'answers': {
			1001: { 'answer': '"קשה לי לנשום."', 'feedback': FEEDBACK_MUST },
			2000: { 'answer': 'החולה שוכב', 'feedback': FEEDBACK_MUST },
			2001: { 'answer': 'לא', 'feedback': FEEDBACK_MUST },
			2002: { 'answer': 'מצפצף', 'feedback': FEEDBACK_MUST },
			2004: { 'answer': '24', 'feedback': FEEDBACK_MUST },
			3001: { 'answer': '120', 'feedback': FEEDBACK_MUST },
			3002: { 'answer': 'חיוור', 'feedback': FEEDBACK_MUST },
			3003: { 'answer': 'לח', 'feedback': FEEDBACK_MUST },
			3005: { 'answer': '100/70', 'feedback': FEEDBACK_MUST },
			3006: { 'answer': 'חם', 'feedback': FEEDBACK_MUST },
			10001: { 'answer': '"כלום"', 'feedback': FEEDBACK_MUST },
			10401: { 'answer': '"זה נבנה בהדרגה במשך 4 ימים"', 'feedback': FEEDBACK_MUST },
			10701: { 'answer': '"מיקרופירין"', 'feedback': FEEDBACK_MUST },
			10702: { 'answer': '"כן"', 'feedback': FEEDBACK_MUST },
			10802: { 'answer': 'לא', 'feedback': FEEDBACK_MUST },
			100001: { 'answer': 'נכון', 'feedback': FEEDBACK_MUST },
			100002: { 'answer': 'נכון', 'feedback': FEEDBACK_MUST },
			100011: { 'answer': 'נכון', 'feedback': FEEDBACK_MUST },
		},
	},
	{
		'intro': 'ירקון 77, בן {0} עם מצוקה נשימתית, {1}',
...
var commands = [
	...
	{ 'command': '"איך הרגשת בימים האחרונים?"', 'key': 11001, 'schema': 'anamnesis', 'schemaorder': 12, 'interaction': 3 },
